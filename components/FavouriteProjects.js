    ...
    <div className="bg-[#F1F1F1] -mt-40 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:-mt-8 pb-40">
          {/* Single card */}
          <a
            href="https://gublias.github.io/GRASP/"
            target="_blank"
          ...
          {/* Single card */}
          <a
            href="https://binarybond.github.io/CSS_WEBSITE/index.html"
            target="_blank"
          ...
          {/* Single card */}
          <a
            href="https://www.figma.com/files/team/1503370432828221513/project/382496759/SwiftMart?fuid=1503370428725895959"
            target="_blank"
          ...
          >
            <div className="relative overflow-hidden group shadow-2xl">
              ...
              <img
                src="/SWIFTMARTUI.png"
                alt="ui"
                className="transform group-hover:scale-125 transition duration-2000 ease-out object-cover shadow-2xl"
              />
              <img src="/swiftmartuf.png" alt="" 
              className="transform group-hover:scale-125 transition duration-2000 ease-out object-cover shadow-2xl"
              />
              <h1 className="absolute top-10 left-10 text-gray-50 font-bold text-xl bg-red-500 rounded-md px-2">
                Ecommerce App UI
